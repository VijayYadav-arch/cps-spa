...
export function Step2ContactAndFacility(_props: StepProps) {
  return (
    <div className="p-6 bg-amber-50 border border-amber-200 rounded-md text-amber-700">
      <p className="font-medium">Step 2: Contact & Facility — placeholder</p>
      <p className="text-sm mt-2">
        ...
        (lines covering step 2: phone, email, address, city, state, zipCode, facilityName,
        facilityType, emergencyContactName, emergencyContactPhone, emergencyContactRelation).
      </p>
    </div>
  );
}
